<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Detailed_Reopened_Report.aspx.cs" Inherits="Default2" %>
               ...
               <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4>Reopened Complaints Report</h4>
                                          <h4>
  ...
  <table class="table">
                        <asp:GridView ID="grdComplaintsReport" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Bold="False" Font-Names="Segoe UI Semibold" Font-Size="8pt" GridLines="Vertical" PageSize="100" ForeColor="#333333" BorderWidth="1px" HorizontalAlign="Center">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="nChannel" HeaderText="Complaint Type" />
                                ...
                                <asp:BoundField DataField="nComplaintCategory" HeaderText="Complaint Reason" />
