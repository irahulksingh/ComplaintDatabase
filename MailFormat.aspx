<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MailFormat.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         ...
         <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="col-xs-4">
                ...
                <asp:TextBox ID="txtiCareNo" runat="server"    CssClass="form-control" OnTextChanged="txtiCareNo_TextChanged" tabIndex="2" MaxLength="8" ></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtiCareNo" ErrorMessage="Required Field" Font-Bold="False" Font-Names="Segoe UI Semibold" Font-Size="8pt" CssClass="auto-style2"></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="txtiCaredate" runat="server"   CssClass="form-control"  AutoPostBack="True" OnTextChanged="txtiCaredate_TextChanged" tabIndex="3" ></asp:TextBox>
  ...
  <div>
      ...
      <table><tr><td>
                     <asp:FileUpload ID="fUpload" runat="server" CssClass="btn btn-info btn-sm pull-right" /></td><td>
